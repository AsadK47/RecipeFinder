...
/// Represents a cooking timer with duration tracking and recipe linking
struct CookTimerModel: Identifiable, Codable, Hashable {
    var id: UUID
    var name: String
...
// MARK: - Common Cooking Timer Presets
